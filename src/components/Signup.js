...
const Signup = (props) => {
    ...
    return (
        ...
        <h2 className='text-center'>Signup for a NOTSI account</h2>
            ...
            <form onSubmit={handleSignup}>
                ...
                <button type="submit" disabled={credentials.name.length < 3 || credentials.password.length < 5} className="btn btn-primary">Signup</button>
            </form>
        </div>
    )
}
